...
def mail():
    name = request.form.getr('name')
    email = request.form.getr('email')
    message = request.form.getr('message')
...
def send_mail(name, email, message):
    ...
    html_content = """
        <p>Hola Gerardo, tienes un nuevo contacto desde la web:</p>
        <p>Nombre: -name-</p>
        <p>Correo: -email-</p>
        <p>Mensaje: -message-</p>
    """
